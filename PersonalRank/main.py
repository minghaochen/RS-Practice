...
class Experiment():
    ...
    def __init__(self, M, N, alpha, fp='../Data/ml-latest-small/ratings.csv'):
        '''
        :params: M, 进行多少次实验
    ...
    def run(self):
        ...
        print('Average Result (M={}, N={}, alpha={}): {}'.format( self.M, self.N, self.alpha, metrics))
